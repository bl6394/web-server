...
public enum SummaryModelMapper {
    ...
    CONCRETENESS_RATING ("cr", "Concreteness_Rating","minConcretenessRating", "maxConcretenessRating"),
    SEMANTIC_NEIGHBORHOOD_DENSITY ("arc", "Semantic_Neighborhood_Density","minSemanticNeighborhoodDensity", "maxSemanticNeighborhoodDensity"),
    SEMANTIC_NEIGHBORS ("sn", "Semantic_Neighbors","minSemanticNeighbors", "maxSemanticNeighbors"),
    SEMANTIC_DIVERSITY ("sd", "Semantic_Diversity","minSemanticDiversity", "maxSemanticDiversity"),
    AGE_OF_ACQUISITION ("aoa", "Age_Of_Acquisition","minAgeOfAcquisition", "maxAgeOfAcquisition"),
    BODY_OBJECT_INTERACTION ("boi", "Body_Object_Interaction","minBodyObjectInteraction", "maxBodyObjectInteraction"),
    EMOTIONAL_VALENCE ("ev", "Emotional_Valence","minEmotionalValence", "maxEmotionalValence"),
    EMOTIONAL_AROUSAL ("ea", "Emotional_Arousal","minEmotionalArousal", "maxEmotionalArousal"),
    EMOTIONAL_DOMINANCE ("ed", "Emotional_Dominance","minEmotionalDominance", "maxEmotionalDominance"),
