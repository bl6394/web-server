...
public class ItemSQLHelper {
    ...
    public String getSQL(String trxId, List<String> fieldNames, String targetDb, List<String> criteria){
        return  "select " + createSelectList(fieldNames) +" from " + targetDb + createCriteriaExpression(criteria);
    }

    public String getSizeSQL(String trxId, List<String> fieldNames, String targetDb, List<String> criteria){
