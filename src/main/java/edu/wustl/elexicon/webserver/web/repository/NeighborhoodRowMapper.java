...
import edu.wustl.elexicon.webserver.web.NeighborhoodViewModelMapper;
...
public class NeighborhoodRowMapper implements RowMapper<Map<String, String>> {
    ...
    public Map<String, String> mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        for (NeighborhoodViewModelMapper mapper : NeighborhoodViewModelMapper.values()) {
